...
#include "SVPLog.h"
    ...
    #undef SVP_LOG_TAG
#endif
#define SVP_LOG_TAG     "navi|pcm"

#define KEY_DELAY_TIME  150000
#define FILE_BUF_LENGTH 204800

static const char*       g_appName = "navi";
...
bool SVPPcmPlayer::PcmInit(const int32_t channels, const uint32_t sampleRate) {
    ...
    g_pSimple = pa_simple_new(NULL, g_appName, PA_STREAM_PLAYBACK, "Navigation", SVPAudioString::SV_AS_TTS_MAP.data(), &g_sampleSpec, NULL, NULL, NULL);
